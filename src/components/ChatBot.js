    ...
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 bg-white border border-gray-200 rounded-lg shadow-xl flex flex-col z-50 overflow-hidden">
          {/* Header */}
          <div className="bg-indigo-600 p-4 text-white font-semibold flex text-start items-center">
              ...
              >
                <div
                  className={`max-w-xs p-3 rounded-lg ${
                    msg.role === 'user'
                      ? 'bg-indigo-100 text-black text-gray-800 rounded-tr-none text-start'
